...
module design_1_wrapper
  ...
  design_1 design_1_i
       (.DDR_addr(DDR_addr),
        ...
        .cam_rst_n(cam_rst_n),
        .cam_vsync(cam_vsync),
        .emio_sccb_tri_i({emio_sccb_tri_i_2,emio_sccb_tri_i_1,emio_sccb_tri_i_0}),
        .emio_sccb_tri_o({emio_sccb_tri_o_2,emio_sccb_tri_o_1,emio_sccb_tri_o_0}),
        .emio_sccb_tri_t({emio_sccb_tri_t_2,emio_sccb_tri_t_1,emio_sccb_tri_t_0}));
