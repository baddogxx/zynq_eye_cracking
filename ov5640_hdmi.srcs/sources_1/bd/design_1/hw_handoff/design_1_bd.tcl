...
proc create_root_design { parentCell } {
  ...
  # Create instance: img_pro_0, and set properties
  set img_pro_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:img_pro:1.0 img_pro_0 ]
  ...
  set_property -dict [ list \
   CONFIG.GEN_F0_VBLANK_HEND {720} \
   CONFIG.GEN_F0_VBLANK_HSTART {720} \
   CONFIG.GEN_F0_VFRAME_SIZE {525} \
   CONFIG.GEN_F0_VSYNC_HEND {720} \
   CONFIG.GEN_F0_VSYNC_HSTART {720} \
   CONFIG.GEN_F0_VSYNC_VEND {494} \
   CONFIG.GEN_F0_VSYNC_VSTART {488} \
   CONFIG.GEN_F1_VBLANK_HEND {720} \
   CONFIG.GEN_F1_VBLANK_HSTART {720} \
   CONFIG.GEN_F1_VFRAME_SIZE {525} \
   CONFIG.GEN_F1_VSYNC_HEND {720} \
   CONFIG.GEN_F1_VSYNC_HSTART {720} \
   CONFIG.GEN_F1_VSYNC_VEND {494} \
   CONFIG.GEN_F1_VSYNC_VSTART {488} \
   CONFIG.GEN_HACTIVE_SIZE {720} \
   CONFIG.GEN_HFRAME_SIZE {858} \
   CONFIG.GEN_HSYNC_END {798} \
   CONFIG.GEN_HSYNC_START {736} \
  ...
  connect_bd_intf_net -intf_net img_pro_0_img_out [get_bd_intf_pins img_pro_0/img_out] [get_bd_intf_pins v_vid_in_axi4s_0/vid_io_in]
  connect_bd_intf_net -intf_net ov5640_capture_data_0_cmos_rgb [get_bd_intf_pins img_pro_0/img_in] [get_bd_intf_pins ov5640_capture_data_0/cmos_rgb]
  ...
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_pins DVI_Transmitter_0/reset_n] [get_bd_pins axi_dynclk_0/LOCKED_O] [get_bd_pins img_pro_0/rst_n] [get_bd_pins ov5640_capture_data_0/rst_n]
  ...
  connect_bd_net -net img_pro_0_img_clken_out [get_bd_pins img_pro_0/img_clken_out] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  ...
  connect_bd_net -net ov5640_capture_data_0_cmos_frame_ce [get_bd_pins img_pro_0/img_clken_in] [get_bd_pins ov5640_capture_data_0/cmos_frame_ce]
  connect_bd_net -net ov5640_capture_data_0_cmos_frame_clk [get_bd_pins img_pro_0/clk] [get_bd_pins ov5640_capture_data_0/cmos_frame_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
